 ...
 *
 * #MosesIconView provides an alternative view on a #GtkTreeModel.
 * It displays the model as a grid of icons with labels. Like
 * #GtkTreeView, it allows to select one or multiple items
 * (depending on the selection mode, see moses_icon_view_set_selection_mode()).
 * In addition to selection with the arrow keys, #MosesIconView supports
 * rubberband selection, which is controlled by dragging the pointer.
 *
 * Note that if the tree model is backed by an actual tree store (as
 * opposed to a flat list where the mapping to icons is obvious),
 * #MosesIconView will only display the first level of the tree and
...
typedef struct _MosesIconViewItem MosesIconViewItem;
struct _MosesIconViewItem
{
...
struct _MosesIconViewPrivate
{
  ...
  MosesIconViewItem *anchor_item;
  MosesIconViewItem *cursor_item;

  MosesIconViewItem *last_single_clicked;
  MosesIconViewItem *last_prelight;
  ...
  MosesIconViewDropPosition dest_pos;
...
typedef struct _MosesIconViewChild MosesIconViewChild;
struct _MosesIconViewChild
{
  GtkWidget    *widget;
  GdkRectangle  area;
};
...
/* GObject vfuncs */
static void             moses_icon_view_cell_layout_init          (GtkCellLayoutIface *iface);
static void             moses_icon_view_dispose                   (GObject            *object);
static void             moses_icon_view_constructed               (GObject            *object);
static void             moses_icon_view_set_property              (GObject            *object,
								 guint               prop_id,
								 const GValue       *value,
								 GParamSpec         *pspec);
static void             moses_icon_view_get_property              (GObject            *object,
								 guint               prop_id,
								 GValue             *value,
								 GParamSpec         *pspec);
/* GtkWidget vfuncs */
static void             moses_icon_view_destroy                   (GtkWidget          *widget);
static void             moses_icon_view_realize                   (GtkWidget          *widget);
static void             moses_icon_view_unrealize                 (GtkWidget          *widget);
static void             moses_icon_view_style_updated             (GtkWidget          *widget);
static void             moses_icon_view_state_flags_changed       (GtkWidget          *widget,
			                                         GtkStateFlags       previous_state);
static GtkSizeRequestMode moses_icon_view_get_request_mode        (GtkWidget          *widget);
static void             moses_icon_view_get_preferred_width       (GtkWidget          *widget,
								 gint               *minimum,
								 gint               *natural);
static void             moses_icon_view_get_preferred_width_for_height
                                                                (GtkWidget          *widget,
                                                                 gint                height,
								 gint               *minimum,
								 gint               *natural);
static void             moses_icon_view_get_preferred_height      (GtkWidget          *widget,
								 gint               *minimum,
								 gint               *natural);
static void             moses_icon_view_get_preferred_height_for_width
                                                                (GtkWidget          *widget,
                                                                 gint                width,
								 gint               *minimum,
								 gint               *natural);
static void             moses_icon_view_size_allocate             (GtkWidget          *widget,
								 GtkAllocation      *allocation);
static gboolean         moses_icon_view_draw                      (GtkWidget          *widget,
                                                                 cairo_t            *cr);
static gboolean         moses_icon_view_motion                    (GtkWidget          *widget,
								 GdkEventMotion     *event);
static gboolean         moses_icon_view_leave                     (GtkWidget          *widget,
								 GdkEventCrossing   *event);
static gboolean         moses_icon_view_button_press              (GtkWidget          *widget,
								 GdkEventButton     *event);
static gboolean         moses_icon_view_button_release            (GtkWidget          *widget,
								 GdkEventButton     *event);
static gboolean         moses_icon_view_key_press                 (GtkWidget          *widget,
								 GdkEventKey        *event);
static gboolean         moses_icon_view_key_release               (GtkWidget          *widget,
								 GdkEventKey        *event);


/* GtkContainer vfuncs */
static void             moses_icon_view_remove                    (GtkContainer       *container,
								 GtkWidget          *widget);
static void             moses_icon_view_forall                    (GtkContainer       *container,
								 gboolean            include_internals,
								 GtkCallback         callback,
								 gpointer            callback_data);

/* MosesIconView vfuncs */
static void             moses_icon_view_real_select_all           (MosesIconView        *icon_view);
static void             moses_icon_view_real_unselect_all         (MosesIconView        *icon_view);
static void             moses_icon_view_real_select_cursor_item   (MosesIconView        *icon_view);
static void             moses_icon_view_real_toggle_cursor_item   (MosesIconView        *icon_view);
static gboolean         moses_icon_view_real_activate_cursor_item (MosesIconView        *icon_view);

 /* Internal functions */
static void                 moses_icon_view_set_hadjustment_values         (MosesIconView            *icon_view);
static void                 moses_icon_view_set_vadjustment_values         (MosesIconView            *icon_view);
static void                 moses_icon_view_set_hadjustment                (MosesIconView            *icon_view,
                                                                          GtkAdjustment          *adjustment);
static void                 moses_icon_view_set_vadjustment                (MosesIconView            *icon_view,
                                                                          GtkAdjustment          *adjustment);
static void                 moses_icon_view_adjustment_changed             (GtkAdjustment          *adjustment,
									  MosesIconView            *icon_view);
static void                 moses_icon_view_layout                         (MosesIconView            *icon_view);
static void                 moses_icon_view_paint_item                     (MosesIconView            *icon_view,
									  cairo_t                *cr,
									  MosesIconViewItem        *item,
									  gint                    x,
									  gint                    y,
									  gboolean                draw_focus);
static void                 moses_icon_view_paint_rubberband               (MosesIconView            *icon_view,
								          cairo_t                *cr);
static void                 moses_icon_view_queue_draw_path                (MosesIconView *icon_view,
									  GtkTreePath *path);
static void                 moses_icon_view_queue_draw_item                (MosesIconView            *icon_view,
									  MosesIconViewItem        *item);
static void                 moses_icon_view_start_rubberbanding            (MosesIconView            *icon_view,
                                                                          GdkDevice              *device,
									  gint                    x,
									  gint                    y);
static void                 moses_icon_view_stop_rubberbanding             (MosesIconView            *icon_view);
static void                 moses_icon_view_update_rubberband_selection    (MosesIconView            *icon_view);
static gboolean             moses_icon_view_item_hit_test                  (MosesIconView            *icon_view,
									  MosesIconViewItem        *item,
									  gint                    x,
									  gint                    y,
									  gint                    width,
									  gint                    height);
static gboolean             moses_icon_view_unselect_all_internal          (MosesIconView            *icon_view);
static void                 moses_icon_view_update_rubberband              (gpointer                data);
static void                 moses_icon_view_item_invalidate_size           (MosesIconViewItem        *item);
static void                 moses_icon_view_invalidate_sizes               (MosesIconView            *icon_view);
static void                 moses_icon_view_add_move_binding               (GtkBindingSet          *binding_set,
									  guint                   keyval,
									  guint                   modmask,
									  GtkMovementStep         step,
									  gint                    count);
static gboolean             moses_icon_view_real_move_cursor               (MosesIconView            *icon_view,
									  GtkMovementStep         step,
									  gint                    count);
static void                 moses_icon_view_move_cursor_up_down            (MosesIconView            *icon_view,
									  gint                    count);
static void                 moses_icon_view_move_cursor_page_up_down       (MosesIconView            *icon_view,
									  gint                    count);
static void                 moses_icon_view_move_cursor_left_right         (MosesIconView            *icon_view,
									  gint                    count);
static void                 moses_icon_view_move_cursor_start_end          (MosesIconView            *icon_view,
									  gint                    count);
static void                 moses_icon_view_scroll_to_item                 (MosesIconView            *icon_view,
									  MosesIconViewItem        *item);
static gboolean             moses_icon_view_select_all_between             (MosesIconView            *icon_view,
									  MosesIconViewItem        *anchor,
									  MosesIconViewItem        *cursor);

static void                 moses_icon_view_ensure_cell_area               (MosesIconView            *icon_view,
                                                                          GtkCellArea            *cell_area);

static GtkCellArea         *moses_icon_view_cell_layout_get_area           (GtkCellLayout          *layout);

static void                 moses_icon_view_item_selected_changed          (MosesIconView            *icon_view,
		                                                          MosesIconViewItem        *item);

static void                 moses_icon_view_add_editable                   (GtkCellArea            *area,
									  GtkCellRenderer        *renderer,
									  GtkCellEditable        *editable,
									  GdkRectangle           *cell_area,
									  const gchar            *path,
									  MosesIconView            *icon_view);
static void                 moses_icon_view_remove_editable                (GtkCellArea            *area,
									  GtkCellRenderer        *renderer,
									  GtkCellEditable        *editable,
									  MosesIconView            *icon_view);
static void                 update_text_cell                             (MosesIconView            *icon_view);
static void                 update_pixbuf_cell                           (MosesIconView            *icon_view);
static MosesIconViewItem*                                                       
_moses_icon_view_get_item_at_coords(MosesIconView          *icon_view,          
                                   gint                  x,                     
                                   gint                  y,                     
...
static void moses_icon_view_drag_begin       (GtkWidget        *widget,
                                            GdkDragContext   *context);
static void moses_icon_view_drag_end         (GtkWidget        *widget,
                                            GdkDragContext   *context);
static void moses_icon_view_drag_data_get    (GtkWidget        *widget,
                                            GdkDragContext   *context,
                                            GtkSelectionData *selection_data,
                                            guint             info,
                                            guint             time);
static void moses_icon_view_drag_data_delete (GtkWidget        *widget,
                                            GdkDragContext   *context);

/* Target side drag signals */
static void     moses_icon_view_drag_leave         (GtkWidget        *widget,
                                                  GdkDragContext   *context,
                                                  guint             time);
static gboolean moses_icon_view_drag_motion        (GtkWidget        *widget,
                                                  GdkDragContext   *context,
                                                  gint              x,
                                                  gint              y,
                                                  guint             time);
static gboolean moses_icon_view_drag_drop          (GtkWidget        *widget,
                                                  GdkDragContext   *context,
                                                  gint              x,
                                                  gint              y,
                                                  guint             time);
static void     moses_icon_view_drag_data_received (GtkWidget        *widget,
                                                  GdkDragContext   *context,
                                                  gint              x,
                                                  gint              y,
                                                  GtkSelectionData *selection_data,
                                                  guint             info,
                                                  guint             time);
static gboolean moses_icon_view_maybe_begin_drag   (MosesIconView             *icon_view,
					   	  GdkEventMotion          *event);

static void     remove_scroll_timeout            (MosesIconView *icon_view);

/* GtkBuildable */
static GtkBuildableIface *parent_buildable_iface;
static void     moses_icon_view_buildable_init             (GtkBuildableIface *iface);
static gboolean moses_icon_view_buildable_custom_tag_start (GtkBuildable  *buildable,
							  GtkBuilder    *builder,
							  GObject       *child,
							  const gchar   *tagname,
							  GMarkupParser *parser,
							  gpointer      *data);
static void     moses_icon_view_buildable_custom_tag_end   (GtkBuildable  *buildable,
							  GtkBuilder    *builder,
							  GObject       *child,
							  const gchar   *tagname,
							  gpointer      *data);
...
G_DEFINE_TYPE_WITH_CODE (MosesIconView, moses_icon_view, GTK_TYPE_CONTAINER,
                         G_ADD_PRIVATE (MosesIconView)
			 G_IMPLEMENT_INTERFACE (GTK_TYPE_CELL_LAYOUT,
						moses_icon_view_cell_layout_init)
			 G_IMPLEMENT_INTERFACE (GTK_TYPE_BUILDABLE,
						moses_icon_view_buildable_init)
...
static void
moses_icon_view_class_init (MosesIconViewClass *klass)
{
  ...
  gobject_class->constructed = moses_icon_view_constructed;
  gobject_class->dispose = moses_icon_view_dispose;
  gobject_class->set_property = moses_icon_view_set_property;
  gobject_class->get_property = moses_icon_view_get_property;

  widget_class->destroy = moses_icon_view_destroy;
  widget_class->realize = moses_icon_view_realize;
  widget_class->unrealize = moses_icon_view_unrealize;
  widget_class->style_updated = moses_icon_view_style_updated;
  widget_class->get_request_mode = moses_icon_view_get_request_mode;
  widget_class->get_preferred_width = moses_icon_view_get_preferred_width;
  widget_class->get_preferred_height = moses_icon_view_get_preferred_height;
  widget_class->get_preferred_width_for_height = moses_icon_view_get_preferred_width_for_height;
  widget_class->get_preferred_height_for_width = moses_icon_view_get_preferred_height_for_width;
  widget_class->size_allocate = moses_icon_view_size_allocate;
  widget_class->draw = moses_icon_view_draw;
  widget_class->motion_notify_event = moses_icon_view_motion;
  widget_class->leave_notify_event = moses_icon_view_leave;
  widget_class->button_press_event = moses_icon_view_button_press;
  widget_class->button_release_event = moses_icon_view_button_release;
  widget_class->key_press_event = moses_icon_view_key_press;
  widget_class->key_release_event = moses_icon_view_key_release;
  widget_class->drag_begin = moses_icon_view_drag_begin;
  widget_class->drag_end = moses_icon_view_drag_end;
  widget_class->drag_data_get = moses_icon_view_drag_data_get;
  widget_class->drag_data_delete = moses_icon_view_drag_data_delete;
  widget_class->drag_leave = moses_icon_view_drag_leave;
  widget_class->drag_motion = moses_icon_view_drag_motion;
  widget_class->drag_drop = moses_icon_view_drag_drop;
  widget_class->drag_data_received = moses_icon_view_drag_data_received;
  widget_class->state_flags_changed = moses_icon_view_state_flags_changed;

  container_class->remove = moses_icon_view_remove;
  container_class->forall = moses_icon_view_forall;

  klass->select_all = moses_icon_view_real_select_all;
  klass->unselect_all = moses_icon_view_real_unselect_all;
  klass->select_cursor_item = moses_icon_view_real_select_cursor_item;
  klass->toggle_cursor_item = moses_icon_view_real_toggle_cursor_item;
  klass->activate_cursor_item = moses_icon_view_real_activate_cursor_item;  
  klass->move_cursor = moses_icon_view_real_move_cursor;
  
  /* Properties */
  /**
   * MosesIconView:selection-mode:
   * 
  ...
  /**
   * MosesIconView:item-orientation:
   *
  ...
  /**
   * MosesIconView:cell-area:
   *
   * The #GtkCellArea used to layout cell renderers for this view.
   *
   * If no area is specified when creating the icon view with moses_icon_view_new_with_area() 
  ...
  /**
   * MosesIconView:activate-on-single-click:
   *
  ...
  icon_view_signals[ITEM_ACTIVATED] =
    g_signal_new (I_("item-activated"),
		  ...
		  G_SIGNAL_RUN_LAST,
		  G_STRUCT_OFFSET (MosesIconViewClass, item_activated),
		  NULL, NULL,
  ...
  /**
   * MosesIconView::selection-changed:
   * @iconview: the object on which the signal is emitted
   *
  ...
  icon_view_signals[SELECTION_CHANGED] =
    g_signal_new (I_("selection-changed"),
		  G_TYPE_FROM_CLASS (gobject_class),
		  G_SIGNAL_RUN_FIRST,
		  G_STRUCT_OFFSET (MosesIconViewClass, selection_changed),
		  NULL, NULL,
  ...
  icon_view_signals[SELECT_ALL] =
    g_signal_new (I_("select-all"),
		  ...
		  G_STRUCT_OFFSET (MosesIconViewClass, select_all),
		  NULL, NULL,
		  g_cclosure_marshal_VOID__VOID,
		  G_TYPE_NONE, 0);
  
  /**
   * MosesIconView::unselect-all:
   * @iconview: the object on which the signal is emitted
   *
   * A [keybinding signal][GtkBindingSignal]
  ...
  icon_view_signals[UNSELECT_ALL] =
    g_signal_new (I_("unselect-all"),
		  G_TYPE_FROM_CLASS (gobject_class),
		  G_SIGNAL_RUN_LAST | G_SIGNAL_ACTION,
		  G_STRUCT_OFFSET (MosesIconViewClass, unselect_all),
		  NULL, NULL,
		  g_cclosure_marshal_VOID__VOID,
		  G_TYPE_NONE, 0);

  /**
   * MosesIconView::select-cursor-item:
   * @iconview: the object on which the signal is emitted
   *
   * A [keybinding signal][GtkBindingSignal]
  ...
  icon_view_signals[SELECT_CURSOR_ITEM] =
    g_signal_new (I_("select-cursor-item"),
		  G_TYPE_FROM_CLASS (gobject_class),
		  G_SIGNAL_RUN_LAST | G_SIGNAL_ACTION,
		  G_STRUCT_OFFSET (MosesIconViewClass, select_cursor_item),
		  NULL, NULL,
		  g_cclosure_marshal_VOID__VOID,
		  G_TYPE_NONE, 0);

  /**
   * MosesIconView::toggle-cursor-item:
   * @iconview: the object on which the signal is emitted
   *
   * A [keybinding signal][GtkBindingSignal]
  ...
  icon_view_signals[TOGGLE_CURSOR_ITEM] =
    g_signal_new (I_("toggle-cursor-item"),
		  G_TYPE_FROM_CLASS (gobject_class),
		  G_SIGNAL_RUN_LAST | G_SIGNAL_ACTION,
		  G_STRUCT_OFFSET (MosesIconViewClass, toggle_cursor_item),
		  NULL, NULL,
		  g_cclosure_marshal_VOID__VOID,
		  G_TYPE_NONE, 0);

  /**
   * MosesIconView::activate-cursor-item:
   * @iconview: the object on which the signal is emitted
   *
   * A [keybinding signal][GtkBindingSignal]
  ...
  icon_view_signals[ACTIVATE_CURSOR_ITEM] =
    g_signal_new (I_("activate-cursor-item"),
		  G_TYPE_FROM_CLASS (gobject_class),
		  G_SIGNAL_RUN_LAST | G_SIGNAL_ACTION,
		  G_STRUCT_OFFSET (MosesIconViewClass, activate_cursor_item),
		  NULL, NULL,
		  _gtk_marshal_BOOLEAN__VOID,
		  G_TYPE_BOOLEAN, 0);
  
  /**
   * MosesIconView::move-cursor:
  ...
  icon_view_signals[MOVE_CURSOR] =
    g_signal_new (I_("move-cursor"),
		  G_TYPE_FROM_CLASS (gobject_class),
		  G_SIGNAL_RUN_LAST | G_SIGNAL_ACTION,
		  G_STRUCT_OFFSET (MosesIconViewClass, move_cursor),
		  NULL, NULL,
  ...
  moses_icon_view_add_move_binding (binding_set, GDK_KEY_Up, 0,
				  GTK_MOVEMENT_DISPLAY_LINES, -1);
  moses_icon_view_add_move_binding (binding_set, GDK_KEY_KP_Up, 0,
				  GTK_MOVEMENT_DISPLAY_LINES, -1);

  moses_icon_view_add_move_binding (binding_set, GDK_KEY_Down, 0,
				  GTK_MOVEMENT_DISPLAY_LINES, 1);
  moses_icon_view_add_move_binding (binding_set, GDK_KEY_KP_Down, 0,
				  GTK_MOVEMENT_DISPLAY_LINES, 1);

  moses_icon_view_add_move_binding (binding_set, GDK_KEY_p, GDK_CONTROL_MASK,
				  GTK_MOVEMENT_DISPLAY_LINES, -1);

  moses_icon_view_add_move_binding (binding_set, GDK_KEY_n, GDK_CONTROL_MASK,
				  GTK_MOVEMENT_DISPLAY_LINES, 1);

  moses_icon_view_add_move_binding (binding_set, GDK_KEY_Home, 0,
				  GTK_MOVEMENT_BUFFER_ENDS, -1);
  moses_icon_view_add_move_binding (binding_set, GDK_KEY_KP_Home, 0,
				  GTK_MOVEMENT_BUFFER_ENDS, -1);

  moses_icon_view_add_move_binding (binding_set, GDK_KEY_End, 0,
				  GTK_MOVEMENT_BUFFER_ENDS, 1);
  moses_icon_view_add_move_binding (binding_set, GDK_KEY_KP_End, 0,
				  GTK_MOVEMENT_BUFFER_ENDS, 1);

  moses_icon_view_add_move_binding (binding_set, GDK_KEY_Page_Up, 0,
				  GTK_MOVEMENT_PAGES, -1);
  moses_icon_view_add_move_binding (binding_set, GDK_KEY_KP_Page_Up, 0,
				  GTK_MOVEMENT_PAGES, -1);

  moses_icon_view_add_move_binding (binding_set, GDK_KEY_Page_Down, 0,
				  GTK_MOVEMENT_PAGES, 1);
  moses_icon_view_add_move_binding (binding_set, GDK_KEY_KP_Page_Down, 0,
				  GTK_MOVEMENT_PAGES, 1);

  moses_icon_view_add_move_binding (binding_set, GDK_KEY_Right, 0, 
				  GTK_MOVEMENT_VISUAL_POSITIONS, 1);
  moses_icon_view_add_move_binding (binding_set, GDK_KEY_Left, 0, 
				  GTK_MOVEMENT_VISUAL_POSITIONS, -1);

  moses_icon_view_add_move_binding (binding_set, GDK_KEY_KP_Right, 0, 
				  GTK_MOVEMENT_VISUAL_POSITIONS, 1);
  moses_icon_view_add_move_binding (binding_set, GDK_KEY_KP_Left, 0, 
				  GTK_MOVEMENT_VISUAL_POSITIONS, -1);
#if 0
  gtk_widget_class_set_accessible_type (widget_class, MOSES_TYPE_ICON_VIEW_ACCESSIBLE);
#endif
}
...
static void
moses_icon_view_buildable_init (GtkBuildableIface *iface)
{
  parent_buildable_iface = g_type_interface_peek_parent (iface);
  iface->add_child = _gtk_cell_layout_buildable_add_child;
  iface->custom_tag_start = moses_icon_view_buildable_custom_tag_start;
  iface->custom_tag_end = moses_icon_view_buildable_custom_tag_end;
}

static void
moses_icon_view_cell_layout_init (GtkCellLayoutIface *iface)
{
  iface->get_area = moses_icon_view_cell_layout_get_area;
}

static void
moses_icon_view_init (MosesIconView *icon_view)
{
  icon_view->priv = moses_icon_view_get_instance_private (icon_view);
...
static void
moses_icon_view_constructed (GObject *object)
{
  MosesIconView *icon_view = MOSES_ICON_VIEW (object);

  G_OBJECT_CLASS (moses_icon_view_parent_class)->constructed (object);

  moses_icon_view_ensure_cell_area (icon_view, NULL);
}

static void
moses_icon_view_dispose (GObject *object)
{
  MosesIconView *icon_view;
  MosesIconViewPrivate *priv;

  icon_view = MOSES_ICON_VIEW (object);
  priv      = icon_view->priv;
  ...
  G_OBJECT_CLASS (moses_icon_view_parent_class)->dispose (object);
}

static void
moses_icon_view_set_property (GObject      *object,
			    guint         prop_id,
			    const GValue *value,
			    GParamSpec   *pspec)
{
  ...
  switch (prop_id)
    ...
    case PROP_SELECTION_MODE:
      moses_icon_view_set_selection_mode (icon_view, g_value_get_enum (value));
      break;
    case PROP_PIXBUF_COLUMN:
      moses_icon_view_set_pixbuf_column (icon_view, g_value_get_int (value));
      break;
    case PROP_TEXT_COLUMN:
      moses_icon_view_set_text_column (icon_view, g_value_get_int (value));
      break;
    case PROP_MARKUP_COLUMN:
      moses_icon_view_set_markup_column (icon_view, g_value_get_int (value));
      break;
    case PROP_MODEL:
      moses_icon_view_set_model (icon_view, g_value_get_object (value));
      break;
    case PROP_ITEM_ORIENTATION:
      moses_icon_view_set_item_orientation (icon_view, g_value_get_enum (value));
      break;
    case PROP_COLUMNS:
      moses_icon_view_set_columns (icon_view, g_value_get_int (value));
      break;
    case PROP_ITEM_WIDTH:
      moses_icon_view_set_item_width (icon_view, g_value_get_int (value));
      break;
    case PROP_SPACING:
      moses_icon_view_set_spacing (icon_view, g_value_get_int (value));
      break;
    case PROP_ROW_SPACING:
      moses_icon_view_set_row_spacing (icon_view, g_value_get_int (value));
      break;
    case PROP_COLUMN_SPACING:
      moses_icon_view_set_column_spacing (icon_view, g_value_get_int (value));
      break;
    case PROP_MARGIN:
      moses_icon_view_set_margin (icon_view, g_value_get_int (value));
      break;
    case PROP_REORDERABLE:
      moses_icon_view_set_reorderable (icon_view, g_value_get_boolean (value));
      break;
      
    case PROP_TOOLTIP_COLUMN:
      moses_icon_view_set_tooltip_column (icon_view, g_value_get_int (value));
      break;

    case PROP_ITEM_PADDING:
      moses_icon_view_set_item_padding (icon_view, g_value_get_int (value));
      break;

    case PROP_ACTIVATE_ON_SINGLE_CLICK:
      moses_icon_view_set_activate_on_single_click (icon_view, g_value_get_boolean (value));
      break;
      ...
      if (area)
        {
          if (icon_view->priv->cell_area != NULL)
            ...
            moses_icon_view_ensure_cell_area (icon_view, area);
        }
      break;

    case PROP_HADJUSTMENT:
      moses_icon_view_set_hadjustment (icon_view, g_value_get_object (value));
      break;
    case PROP_VADJUSTMENT:
      moses_icon_view_set_vadjustment (icon_view, g_value_get_object (value));
      break;
...
static void
moses_icon_view_get_property (GObject      *object,
			    guint         prop_id,
			    GValue       *value,
			    GParamSpec   *pspec)
{
...
/* GtkWidget methods */
static void
moses_icon_view_destroy (GtkWidget *widget)
{
  MosesIconView *icon_view = MOSES_ICON_VIEW (widget);

  moses_icon_view_set_model (icon_view, NULL);
  ...
  GTK_WIDGET_CLASS (moses_icon_view_parent_class)->destroy (widget);
}

static void
moses_icon_view_realize (GtkWidget *widget)
{
  MosesIconView *icon_view = MOSES_ICON_VIEW (widget);
  GtkAllocation allocation;
  GdkWindow *window;
...
static void
moses_icon_view_unrealize (GtkWidget *widget)
{
  MosesIconView *icon_view;
  ...
  GTK_WIDGET_CLASS (moses_icon_view_parent_class)->unrealize (widget);
}

static void
_moses_icon_view_update_background (MosesIconView *icon_view)
{
...
static void
moses_icon_view_state_flags_changed (GtkWidget     *widget,
                                   GtkStateFlags  previous_state)
{
  _moses_icon_view_update_background (MOSES_ICON_VIEW (widget));
  gtk_widget_queue_draw (widget);
}

static void
moses_icon_view_style_updated (GtkWidget *widget)
{
  GTK_WIDGET_CLASS (moses_icon_view_parent_class)->style_updated (widget);
...
static gint
moses_icon_view_get_n_items (MosesIconView *icon_view)
{
  MosesIconViewPrivate *priv = icon_view->priv;
...
static void
adjust_wrap_width (MosesIconView *icon_view)
{
 ...
 */
static void
cell_area_get_preferred_size (MosesIconView        *icon_view,
...
static gboolean
moses_icon_view_is_empty (MosesIconView *icon_view)
{
  return icon_view->priv->items == NULL;
}

static void
moses_icon_view_get_preferred_item_size (MosesIconView    *icon_view,
                                       GtkOrientation  orientation,
                                       gint            for_size,
                                       gint           *minimum,
                                       gint           *natural)
{
  ...
  g_assert (!moses_icon_view_is_empty (icon_view));
  ...
  if (for_size > 0)
    {
      ...
      for (items = priv->items; items; items = items->next)
        {
          MosesIconViewItem *item = items->data;

          _moses_icon_view_set_cell_data (icon_view, item);
...
static void
moses_icon_view_compute_n_items_for_size (MosesIconView    *icon_view,
                                        GtkOrientation  orientation,
                                        gint            size,
                                        gint           *min_items,
                                        gint           *min_item_size,
                                        ...
                                        gint           *max_item_size)
{
  ...
  g_return_if_fail (!moses_icon_view_is_empty (icon_view));

  moses_icon_view_get_preferred_item_size (icon_view, orientation, -1, &minimum, &natural);
  ...
  if (priv->columns > 0)
    {
      if (orientation == GTK_ORIENTATION_HORIZONTAL)
        ...
        {
          int n_items = moses_icon_view_get_n_items (icon_view);
...
moses_icon_view_get_request_mode (GtkWidget *widget)
{
  return GTK_SIZE_REQUEST_HEIGHT_FOR_WIDTH;
}

static void
moses_icon_view_get_preferred_width (GtkWidget *widget,
				   gint      *minimum,
				   gint      *natural)
{
  MosesIconView *icon_view = MOSES_ICON_VIEW (widget);
  ...
  if (moses_icon_view_is_empty (icon_view))
    {
      *minimum = *natural = 2 * priv->margin;
      return;
    }

  moses_icon_view_get_preferred_item_size (icon_view, GTK_ORIENTATION_HORIZONTAL, -1, &item_min, &item_nat);
...
static void
moses_icon_view_get_preferred_width_for_height (GtkWidget *widget,
                                              gint       height,
                                              gint      *minimum,
                                              gint      *natural)
{
  ...
  moses_icon_view_compute_n_items_for_size (icon_view, GTK_ORIENTATION_VERTICAL, height, &rows, &row_height, NULL, NULL);
  n_items = moses_icon_view_get_n_items (icon_view);

  moses_icon_view_get_preferred_item_size (icon_view, GTK_ORIENTATION_HORIZONTAL, row_height, &item_min, &item_nat);
...
static void
moses_icon_view_get_preferred_height (GtkWidget *widget,
				    gint      *minimum,
				    gint      *natural)
{
  MosesIconView *icon_view = MOSES_ICON_VIEW (widget);
  ...
  moses_icon_view_get_preferred_item_size (icon_view, GTK_ORIENTATION_VERTICAL, -1, &item_min, &item_nat);
  n_items = moses_icon_view_get_n_items (icon_view);
...
static void
moses_icon_view_get_preferred_height_for_width (GtkWidget *widget,
                                              gint       width,
                                              gint      *minimum,
                                              gint      *natural)
{
  ...
  moses_icon_view_compute_n_items_for_size (icon_view, GTK_ORIENTATION_HORIZONTAL, width, NULL, NULL, &columns, &column_width);
  n_items = moses_icon_view_get_n_items (icon_view);

  moses_icon_view_get_preferred_item_size (icon_view, GTK_ORIENTATION_VERTICAL, column_width, &item_min, &item_nat);
...
static void
moses_icon_view_allocate_children (MosesIconView *icon_view)
{
  GList *list;

  for (list = icon_view->priv->children; list; list = list->next)
    {
      MosesIconViewChild *child = list->data;
...
static void
moses_icon_view_size_allocate (GtkWidget      *widget,
			     GtkAllocation  *allocation)
{
  MosesIconView *icon_view = MOSES_ICON_VIEW (widget);
  ...
  moses_icon_view_layout (icon_view);
  ...
  moses_icon_view_allocate_children (icon_view);
  ...
  moses_icon_view_set_hadjustment_values (icon_view);
  moses_icon_view_set_vadjustment_values (icon_view);
  ...
  if (gtk_widget_get_realized (widget) &&
      icon_view->priv->scroll_to_path)
    {
      ...
      moses_icon_view_scroll_to_path (icon_view, path,
...
static gboolean
moses_icon_view_draw (GtkWidget *widget,
                    cairo_t   *cr)
{
  MosesIconView *icon_view;
  GList *icons;
  ...
  gint dest_index;
  MosesIconViewDropPosition dest_pos;
  MosesIconViewItem *dest_item = NULL;
  GtkStyleContext *context;
  ...
  moses_icon_view_get_drag_dest_item (icon_view, &path, &dest_pos);
  ...
  for (icons = icon_view->priv->items; icons; icons = icons->next)
    {
      MosesIconViewItem *item = icons->data;
      ...
      if (gdk_cairo_get_clip_rectangle (cr, NULL))
        {
          moses_icon_view_paint_item (icon_view, cr, item,
  ...
  if (dest_item &&
      dest_pos != MOSES_ICON_VIEW_NO_DROP)
    {
      GtkStyleContext *context;
      GdkRectangle rect = { 0 };
  ...
  if (icon_view->priv->doing_rubberband)
    moses_icon_view_paint_rubberband (icon_view, cr);

  cairo_restore (cr);

  return GTK_WIDGET_CLASS (moses_icon_view_parent_class)->draw (widget, cr);
}

static gboolean
rubberband_scroll_timeout (gpointer data)
{
  MosesIconView *icon_view = data;

  gtk_adjustment_set_value (icon_view->priv->vadjustment,
                            gtk_adjustment_get_value (icon_view->priv->vadjustment) +
                            icon_view->priv->scroll_value_diff);

  moses_icon_view_update_rubberband (icon_view);
  
  return TRUE;
}

static gboolean
moses_icon_view_motion (GtkWidget      *widget,
		      GdkEventMotion *event)
{
  GtkAllocation allocation;
  MosesIconView *icon_view;
  ...
  moses_icon_view_maybe_begin_drag (icon_view, event);

  if (icon_view->priv->doing_rubberband)
    {
      moses_icon_view_update_rubberband (widget);
    ...
    {
      MosesIconViewItem *item, *last_prelight_item;
      GtkCellRenderer *cell = NULL;

      last_prelight_item = icon_view->priv->last_prelight;
      item = _moses_icon_view_get_item_at_coords (icon_view,
                                               event->x, event->y,
                                               FALSE,
                                               &cell);
      ...
      if (item != last_prelight_item)
        {
          if (item != NULL)
            {
              moses_icon_view_queue_draw_item (icon_view, item);
            }

          if (last_prelight_item != NULL)
            {
              moses_icon_view_queue_draw_item (icon_view,
...
static gboolean
moses_icon_view_leave (GtkWidget        *widget,
                     GdkEventCrossing *event)
{
  MosesIconView *icon_view;
  MosesIconViewPrivate *priv;
  ...
  if (priv->last_prelight)
    {
      moses_icon_view_queue_draw_item (icon_view, priv->last_prelight);
...
static void
moses_icon_view_remove (GtkContainer *container,
		      GtkWidget    *widget)
{
  MosesIconView *icon_view;
  MosesIconViewChild *child = NULL;
  GList *tmp_list;

  icon_view = MOSES_ICON_VIEW (container);
...
static void
moses_icon_view_forall (GtkContainer *container,
		      gboolean      include_internals,
		      GtkCallback   callback,
		      gpointer      callback_data)
{
...
static void 
moses_icon_view_item_selected_changed (MosesIconView      *icon_view,
                                     MosesIconViewItem  *item)
{
  AtkObject *obj;
  AtkObject *item_obj;
...
static void
moses_icon_view_add_editable (GtkCellArea            *area,
			    GtkCellRenderer        *renderer,
			    GtkCellEditable        *editable,
			    GdkRectangle           *cell_area,
			    const gchar            *path,
			    MosesIconView            *icon_view)
{
  MosesIconViewChild *child;
  GtkWidget *widget = GTK_WIDGET (editable);
  
  child = g_new (MosesIconViewChild, 1);
...
static void
moses_icon_view_remove_editable (GtkCellArea            *area,
			       GtkCellRenderer        *renderer,
			       GtkCellEditable        *editable,
			       MosesIconView            *icon_view)
{
  ...
  moses_icon_view_queue_draw_path (icon_view, path);
  gtk_tree_path_free (path);
}

/**
 * moses_icon_view_set_cursor:
 ...
 **/
void
moses_icon_view_set_cursor (MosesIconView     *icon_view,
			  GtkTreePath     *path,
			  GtkCellRenderer *cell,
			  gboolean         start_editing)
{
  MosesIconViewItem *item = NULL;

  g_return_if_fail (MOSES_IS_ICON_VIEW (icon_view));
  ...
  _moses_icon_view_set_cursor_item (icon_view, item, cell);
  moses_icon_view_scroll_to_path (icon_view, path, FALSE, 0.0, 0.0);
 ...
 **/
gboolean
moses_icon_view_get_cursor (MosesIconView      *icon_view,
			  GtkTreePath     **path,
			  GtkCellRenderer **cell)
{
  MosesIconViewItem *item;

  g_return_val_if_fail (MOSES_IS_ICON_VIEW (icon_view), FALSE);
...
static gboolean
moses_icon_view_button_press (GtkWidget      *widget,
			    GdkEventButton *event)
{
  MosesIconView *icon_view;
  MosesIconViewItem *item;
  ...
  if (event->button == GDK_BUTTON_PRIMARY && event->type == GDK_BUTTON_PRESS)
      ...
      if (item != NULL && (cell != NULL || item->selected))
	{
	  ...
	  moses_icon_view_scroll_to_item (icon_view, item);
	  
	  if (icon_view->priv->selection_mode == GTK_SELECTION_NONE)
	    {
	      _moses_icon_view_set_cursor_item (icon_view, item, cursor_cell);
	    }
	  else if (icon_view->priv->selection_mode == GTK_SELECTION_MULTIPLE &&
		   (event->state & extend_mod_mask))
	    {
	      moses_icon_view_unselect_all_internal (icon_view);

	      _moses_icon_view_set_cursor_item (icon_view, item, cursor_cell);
	      if (!icon_view->priv->anchor_item)
		icon_view->priv->anchor_item = item;
	      else 
		moses_icon_view_select_all_between (icon_view,
      ...
      else
	{
	  if (icon_view->priv->selection_mode != GTK_SELECTION_BROWSE &&
	      !(event->state & modify_mod_mask))
	    {
	      dirty = moses_icon_view_unselect_all_internal (icon_view);
	    }
	  
	  if (icon_view->priv->selection_mode == GTK_SELECTION_MULTIPLE)
            moses_icon_view_start_rubberbanding (icon_view, event->device, event->x, event->y);
	}
  ...
  if (!icon_view->priv->activate_on_single_click
      ...
      if (item && item == icon_view->priv->last_single_clicked)
	{
	  ...
	  path = gtk_tree_path_new_from_indices (item->index, -1);
	  moses_icon_view_item_activated (icon_view, path);
	  gtk_tree_path_free (path);
	}
...
static gboolean
moses_icon_view_button_release (GtkWidget      *widget,
			      GdkEventButton *event)
{
  MosesIconView *icon_view;
  ...
  moses_icon_view_stop_rubberbanding (icon_view);
...
static gboolean
moses_icon_view_key_press (GtkWidget      *widget,
			 GdkEventKey    *event)
{
  MosesIconView *icon_view = MOSES_ICON_VIEW (widget);
  ...
  return GTK_WIDGET_CLASS (moses_icon_view_parent_class)->key_press_event (widget, event);
}

static gboolean
moses_icon_view_key_release (GtkWidget      *widget,
			   GdkEventKey    *event)
{
  MosesIconView *icon_view = MOSES_ICON_VIEW (widget);
  ...
  return GTK_WIDGET_CLASS (moses_icon_view_parent_class)->key_release_event (widget, event);
}

static void
moses_icon_view_update_rubberband (gpointer data)
{
  MosesIconView *icon_view;
  gint x, y;
  ...
  icon_view = MOSES_ICON_VIEW (data);
  ...
  moses_icon_view_update_rubberband_selection (icon_view);
}

static void
moses_icon_view_start_rubberbanding (MosesIconView  *icon_view,
                                   GdkDevice    *device,
				   gint          x,
				   gint          y)
{
...
static void
moses_icon_view_stop_rubberbanding (MosesIconView *icon_view)
{
  if (!icon_view->priv->doing_rubberband)
    return;
...
static void
moses_icon_view_update_rubberband_selection (MosesIconView *icon_view)
{
  GList *items;
  ...
  for (items = icon_view->priv->items; items; items = items->next)
    {
      ...
      is_in = moses_icon_view_item_hit_test (icon_view, item, 
					   x, y, width, height);
...
static gboolean
moses_icon_view_item_hit_test (MosesIconView      *icon_view,
			     MosesIconViewItem  *item,
			     gint              x,
			     gint              y,
			     gint              width,
...
static gboolean
moses_icon_view_unselect_all_internal (MosesIconView  *icon_view)
{
  gboolean dirty = FALSE;
  GList *items;
  ...
  for (items = icon_view->priv->items; items; items = items->next)
      ...
      if (item->selected)
	{
	  ...
	  dirty = TRUE;
	  moses_icon_view_queue_draw_item (icon_view, item);
	  moses_icon_view_item_selected_changed (icon_view, item);
	}
    }
...
/* MosesIconView signals */
static void
moses_icon_view_real_select_all (MosesIconView *icon_view)
{
  moses_icon_view_select_all (icon_view);
}

static void
moses_icon_view_real_unselect_all (MosesIconView *icon_view)
{
  moses_icon_view_unselect_all (icon_view);
}

static void
moses_icon_view_real_select_cursor_item (MosesIconView *icon_view)
{
  moses_icon_view_unselect_all (icon_view);

  if (icon_view->priv->cursor_item != NULL)
    _moses_icon_view_select_item (icon_view, icon_view->priv->cursor_item);
}

static gboolean
moses_icon_view_real_activate_cursor_item (MosesIconView *icon_view)
{
  GtkTreePath *path;
  GtkCellAreaContext *context;
  ...
  _moses_icon_view_set_cell_data (icon_view, icon_view->priv->cursor_item);
  gtk_cell_area_activate (icon_view->priv->cell_area, context,
                          GTK_WIDGET (icon_view),
...
static void
moses_icon_view_real_toggle_cursor_item (MosesIconView *icon_view)
{
  if (!icon_view->priv->cursor_item)
    return;
  ...
  switch (icon_view->priv->selection_mode)
	...
	_moses_icon_view_unselect_item (icon_view, icon_view->priv->cursor_item);
      else
	_moses_icon_view_select_item (icon_view, icon_view->priv->cursor_item);
      break;
    case GTK_SELECTION_MULTIPLE:
      ...
      moses_icon_view_item_selected_changed (icon_view, icon_view->priv->cursor_item);      
      moses_icon_view_queue_draw_item (icon_view, icon_view->priv->cursor_item);
      break;
    }
}

static void
moses_icon_view_set_hadjustment_values (MosesIconView *icon_view)
{
  GtkAllocation  allocation;
...
static void
moses_icon_view_set_vadjustment_values (MosesIconView *icon_view)
{
  GtkAllocation  allocation;
...
static void
moses_icon_view_set_hadjustment (MosesIconView   *icon_view,
                               GtkAdjustment *adjustment)
{
  MosesIconViewPrivate *priv = icon_view->priv;
  ...
  g_signal_connect (adjustment, "value-changed",
                    G_CALLBACK (moses_icon_view_adjustment_changed), icon_view);
...
static void
moses_icon_view_set_vadjustment (MosesIconView   *icon_view,
                               GtkAdjustment *adjustment)
{
  MosesIconViewPrivate *priv = icon_view->priv;
...
static void
moses_icon_view_adjustment_changed (GtkAdjustment *adjustment,
                                  MosesIconView   *icon_view)
{
  MosesIconViewPrivate *priv = icon_view->priv;
  ...
  if (gtk_widget_get_realized (GTK_WIDGET (icon_view)))
    {
      ...
      if (icon_view->priv->doing_rubberband)
        moses_icon_view_update_rubberband (GTK_WIDGET (icon_view));

#if 0
      _moses_icon_view_accessible_adjustment_changed (icon_view);
#endif
    }
}
...
static void
moses_icon_view_layout (MosesIconView *icon_view)
{
  MosesIconViewPrivate *priv = icon_view->priv;
  GtkWidget *widget = GTK_WIDGET (icon_view);
  GList *items;
  ...
  moses_icon_view_compute_n_items_for_size (icon_view, 
  ...
  for (items = priv->items; items; items = items->next)
    {
      _moses_icon_view_set_cell_data (icon_view, items->data);
...
static void
moses_icon_view_invalidate_sizes (MosesIconView *icon_view)
{
  /* Clear all item sizes */
  g_list_foreach (icon_view->priv->items,
		  (GFunc)moses_icon_view_item_invalidate_size, NULL);
...
static void
moses_icon_view_item_invalidate_size (MosesIconViewItem *item)
{
...
static void
moses_icon_view_paint_item (MosesIconView     *icon_view,
                          cairo_t         *cr,
                          MosesIconViewItem *item,
                          gint             x,
                          gint             y,
...
static void
moses_icon_view_paint_rubberband (MosesIconView     *icon_view,
				cairo_t         *cr)
{
  GtkStyleContext *context;
  GdkRectangle rect;
...
static void
moses_icon_view_queue_draw_path (MosesIconView *icon_view,
			       GtkTreePath *path)
{
  GList *l;
  gint index;
...
static void
moses_icon_view_queue_draw_item (MosesIconView     *icon_view,
			       MosesIconViewItem *item)
{
  GdkRectangle  rect;
  GdkRectangle *item_area = &item->cell_area;
...
void
_moses_icon_view_set_cursor_item (MosesIconView     *icon_view,
                                MosesIconViewItem *item,
...
static MosesIconViewItem *
moses_icon_view_item_new (void)
{
  MosesIconViewItem *item;

  item = g_slice_new0 (MosesIconViewItem);
...
static void
moses_icon_view_item_free (MosesIconViewItem *item)
{
  g_return_if_fail (item != NULL);

  g_slice_free (MosesIconViewItem, item);
}
...
void
_moses_icon_view_select_item (MosesIconView      *icon_view,
                            MosesIconViewItem  *item)
{
  g_return_if_fail (MOSES_IS_ICON_VIEW (icon_view));
  g_return_if_fail (item != NULL);
...
void
_moses_icon_view_unselect_item (MosesIconView      *icon_view,
                              MosesIconViewItem  *item)
{
  g_return_if_fail (MOSES_IS_ICON_VIEW (icon_view));
  g_return_if_fail (item != NULL);
...
static void
verify_items (MosesIconView *icon_view)
{
  GList *items;
  int i = 0;
...
static void
moses_icon_view_row_changed (GtkTreeModel *model,
                           GtkTreePath  *path,
                           GtkTreeIter  *iter,
                           gpointer      data)
{
  MosesIconView *icon_view = MOSES_ICON_VIEW (data);
   ...
   *
   * For now MosesIconView still cant deal with huge models
   * so just invalidate the whole thing when the model
   * changes.
   */
  moses_icon_view_invalidate_sizes (icon_view);

  verify_items (icon_view);
}

static void
moses_icon_view_row_inserted (GtkTreeModel *model,
			    GtkTreePath  *path,
			    GtkTreeIter  *iter,
			    gpointer      data)
{
...
static void
moses_icon_view_row_deleted (GtkTreeModel *model,
			   GtkTreePath  *path,
			   gpointer      data)
{
  MosesIconView *icon_view = MOSES_ICON_VIEW (data);
  ...
  moses_icon_view_item_free (item);
...
static void
moses_icon_view_rows_reordered (GtkTreeModel *model,
			      GtkTreePath  *parent,
			      GtkTreeIter  *iter,
			      gint         *new_order,
			      gpointer      data)
{
  ...
  item_array = g_new (MosesIconViewItem *, length);
...
static void
moses_icon_view_build_items (MosesIconView *icon_view)
{
  GtkTreeIter iter;
  int i;
  GList *items = NULL;
  ...
  do
    {
      MosesIconViewItem *item = moses_icon_view_item_new ();
...
static void
moses_icon_view_add_move_binding (GtkBindingSet  *binding_set,
				guint           keyval,
				guint           modmask,
				GtkMovementStep step,
				gint            count)
...
static gboolean
moses_icon_view_real_move_cursor (MosesIconView     *icon_view,
				GtkMovementStep  step,
				gint             count)
{
  GdkModifierType state;

  g_return_val_if_fail (MOSES_ICON_VIEW (icon_view), FALSE);
  ...
  switch (step)
    ...
    case GTK_MOVEMENT_VISUAL_POSITIONS:
      moses_icon_view_move_cursor_left_right (icon_view, count);
      break;
    case GTK_MOVEMENT_DISPLAY_LINES:
      moses_icon_view_move_cursor_up_down (icon_view, count);
      break;
    case GTK_MOVEMENT_PAGES:
      moses_icon_view_move_cursor_page_up_down (icon_view, count);
      break;
    case GTK_MOVEMENT_BUFFER_ENDS:
      moses_icon_view_move_cursor_start_end (icon_view, count);
      break;
    default:
...
static MosesIconViewItem *
find_item (MosesIconView     *icon_view,
	   MosesIconViewItem *current,
	   gint             row_ofs,
	   gint             col_ofs)
{
  gint row, col;
...
static MosesIconViewItem *
find_item_page_up_down (MosesIconView     *icon_view,
			MosesIconViewItem *current,
			gint             count)
{
  GList *item, *next;
  ...
  if (count > 0)
      ...
      while (item)
	{
	  for (next = item->next; next; next = next->next)
	    {
	      if (((MosesIconViewItem *)next->data)->col == col)
		break;
	    }
	  if (!next || ((MosesIconViewItem *)next->data)->cell_area.y > y)
	    break;
...
static gboolean
moses_icon_view_select_all_between (MosesIconView     *icon_view,
				  MosesIconViewItem *anchor,
				  MosesIconViewItem *cursor)
{
  GList *items;
...
static void 
moses_icon_view_move_cursor_up_down (MosesIconView *icon_view,
				   gint         count)
{
  MosesIconViewItem *item;
  GtkCellRenderer *cell = NULL;
  ...
  if (!icon_view->priv->modify_selection_pressed &&
    ...
    {
      dirty = moses_icon_view_unselect_all_internal (icon_view);
      dirty = moses_icon_view_select_all_between (icon_view, 
						icon_view->priv->anchor_item,
						item) || dirty;
    }
...
static void 
moses_icon_view_move_cursor_page_up_down (MosesIconView *icon_view,
					gint         count)
{
  MosesIconViewItem *item;
  gboolean dirty = FALSE;
  ...
  _moses_icon_view_set_cursor_item (icon_view, item, NULL);
...
static void 
moses_icon_view_move_cursor_left_right (MosesIconView *icon_view,
				      gint         count)
{
  MosesIconViewItem *item;
  GtkCellRenderer *cell = NULL;
...
static void 
moses_icon_view_move_cursor_start_end (MosesIconView *icon_view,
				     gint         count)
{
  MosesIconViewItem *item;
  GList *list;
...
/**
 * moses_icon_view_scroll_to_path:
 * @icon_view: A #MosesIconView.
 ...
 **/
void
moses_icon_view_scroll_to_path (MosesIconView *icon_view,
			      GtkTreePath *path,
			      gboolean     use_align,
			      gfloat       row_align,
			      gfloat       col_align)
...
static void
moses_icon_view_scroll_to_item (MosesIconView     *icon_view,
                              MosesIconViewItem *item)
{
  MosesIconViewPrivate *priv = icon_view->priv;
  GtkWidget *widget = GTK_WIDGET (icon_view);
...
static void
moses_icon_view_ensure_cell_area (MosesIconView *icon_view,
                                GtkCellArea *cell_area)
{
  MosesIconViewPrivate *priv = icon_view->priv;
  ...
  priv->add_editable_id =
    g_signal_connect (priv->cell_area, "add-editable",
                      G_CALLBACK (moses_icon_view_add_editable), icon_view);
  priv->remove_editable_id =
    g_signal_connect (priv->cell_area, "remove-editable",
                      G_CALLBACK (moses_icon_view_remove_editable), icon_view);
...
static GtkCellArea *
moses_icon_view_cell_layout_get_area (GtkCellLayout *cell_layout)
{
  MosesIconView *icon_view = MOSES_ICON_VIEW (cell_layout);
  MosesIconViewPrivate *priv = icon_view->priv;
...
void
_moses_icon_view_set_cell_data (MosesIconView     *icon_view,
			      MosesIconViewItem *item)
{
  GtkTreeIter iter;
  GtkTreePath *path;
 ...
 * moses_icon_view_new:
 * 
 * Creates a new #MosesIconView widget
 * 
 * Returns: A newly created #MosesIconView widget
 *
 * Since: 2.6
 **/
GtkWidget *
moses_icon_view_new (void)
{
  return g_object_new (MOSES_TYPE_ICON_VIEW, NULL);
}

/**
 * moses_icon_view_new_with_area:
 * @area: the #GtkCellArea to use to layout cells
 * 
 * Creates a new #MosesIconView widget using the
 ...
 **/
GtkWidget *
moses_icon_view_new_with_area (GtkCellArea *area)
{
  return g_object_new (MOSES_TYPE_ICON_VIEW, "cell-area", area, NULL);
}

/**
 * moses_icon_view_new_with_model:
 * @model: The model.
 * 
 * Creates a new #MosesIconView widget with the model @model.
 * 
 * Returns: A newly created #MosesIconView widget.
 *
 * Since: 2.6 
 **/
GtkWidget *
moses_icon_view_new_with_model (GtkTreeModel *model)
{
  return g_object_new (MOSES_TYPE_ICON_VIEW, "model", model, NULL);
}

/**
 * moses_icon_view_convert_widget_to_bin_window_coords:
 * @icon_view: a #MosesIconView 
 ...
 * as expected by e.g. moses_icon_view_get_path_at_pos(). 
 *
 * Since: 2.12
 */
void
moses_icon_view_convert_widget_to_bin_window_coords (MosesIconView *icon_view,
                                                   gint         wx,
                                                   gint         wy, 
                                                   gint        *bx,
                                                   gint        *by)
...
/**
 * moses_icon_view_get_path_at_pos:
 * @icon_view: A #MosesIconView.
 * @x: The x position to be identified
 * @y: The y position to be identified
 * 
 * Finds the path at the point (@x, @y), relative to bin_window coordinates.
 * See moses_icon_view_get_item_at_pos(), if you are also interested in
 * the cell at the specified position. 
 * See moses_icon_view_convert_widget_to_bin_window_coords() for converting
 ...
 **/
GtkTreePath *
moses_icon_view_get_path_at_pos (MosesIconView *icon_view,
			       gint         x,
			       gint         y)
{
  MosesIconViewItem *item;
  ...
  g_return_val_if_fail (MOSES_IS_ICON_VIEW (icon_view), NULL);

  item = _moses_icon_view_get_item_at_coords (icon_view, x, y, TRUE, NULL);
...
/**
 * moses_icon_view_get_item_at_pos:
 * @icon_view: A #MosesIconView.
 * @x: The x position to be identified
 * @y: The y position to be identified
 ...
 * 
 * Finds the path at the point (@x, @y), relative to bin_window coordinates.
 * In contrast to moses_icon_view_get_path_at_pos(), this function also 
 ...
 **/
gboolean 
moses_icon_view_get_item_at_pos (MosesIconView      *icon_view,
			       gint              x,
			       gint              y,
			       GtkTreePath     **path,
			       GtkCellRenderer **cell)
{
  ...
  item = _moses_icon_view_get_item_at_coords (icon_view, x, y, TRUE, &renderer);
 ...
 */
gboolean
moses_icon_view_get_cell_rect (MosesIconView     *icon_view,
                             GtkTreePath     *path,
                             GtkCellRenderer *cell,
                             GdkRectangle    *rect)
{
...
/**
 * moses_icon_view_set_tooltip_item:
 * @icon_view: a #MosesIconView
 * @tooltip: a #GtkTooltip
 * @path: a #GtkTreePath
 * 
 * Sets the tip area of @tooltip to be the area covered by the item at @path.
 * See also moses_icon_view_set_tooltip_column() for a simpler alternative.
 * See also gtk_tooltip_set_tip_area().
 * 
 * Since: 2.12
 */
void 
moses_icon_view_set_tooltip_item (MosesIconView     *icon_view,
                                GtkTooltip      *tooltip,
                                GtkTreePath     *path)
{
  g_return_if_fail (MOSES_IS_ICON_VIEW (icon_view));
  ...
  moses_icon_view_set_tooltip_cell (icon_view, tooltip, path, NULL);
}

/**
 * moses_icon_view_set_tooltip_cell:
 * @icon_view: a #MosesIconView
 * @tooltip: a #GtkTooltip
 * @path: a #GtkTreePath
 * @cell: (allow-none): a #GtkCellRenderer or %NULL
 ...
 */
void
moses_icon_view_set_tooltip_cell (MosesIconView     *icon_view,
                                GtkTooltip      *tooltip,
                                GtkTreePath     *path,
                                GtkCellRenderer *cell)
{
  ...
  if (!moses_icon_view_get_cell_rect (icon_view, path, cell, &rect))
    return;
...
/**
 * moses_icon_view_get_tooltip_context:
 * @icon_view: an #MosesIconView
 ...
 * signal handler for #MosesIconView.  The @x, @y and @keyboard_tip values
 ...
 */
gboolean
moses_icon_view_get_tooltip_context (MosesIconView   *icon_view,
                                   gint          *x,
                                   gint          *y,
                                   ...
                                   GtkTreeIter   *iter)
{
  ...
  if (keyboard_tip)
    {
      moses_icon_view_get_cursor (icon_view, &tmppath, NULL);
    ...
    {
      moses_icon_view_convert_widget_to_bin_window_coords (icon_view, *x, *y,
                                                         x, y);

      if (!moses_icon_view_get_item_at_pos (icon_view, *x, *y, &tmppath, NULL))
        return FALSE;
    }

  if (model)
    *model = moses_icon_view_get_model (icon_view);

  if (iter)
    gtk_tree_model_get_iter (moses_icon_view_get_model (icon_view),
                             iter, tmppath);
...
static gboolean
moses_icon_view_set_tooltip_query_cb (GtkWidget  *widget,
                                    gint        x,
                                    gint        y,
                                    gboolean    keyboard_tip,
                                    GtkTooltip *tooltip,
                                    gpointer    data)
{
  ...
  if (!moses_icon_view_get_tooltip_context (MOSES_ICON_VIEW (widget),
                                          &x, &y,
                                          keyboard_tip,
                                          &model, &path, &iter))
    return FALSE;
  ...
  moses_icon_view_set_tooltip_item (icon_view, tooltip, path);
...
/**
 * moses_icon_view_set_tooltip_column:
 * @icon_view: a #MosesIconView
 * @column: an integer, which is a valid column number for @icon_view’s model
 *
 * If you only plan to have simple (text-only) tooltips on full items, you
 * can use this function to have #MosesIconView handle these automatically
 ...
 */
void
moses_icon_view_set_tooltip_column (MosesIconView *icon_view,
                                  gint         column)
{
  g_return_if_fail (MOSES_IS_ICON_VIEW (icon_view));
  ...
  if (column == -1)
    {
      g_signal_handlers_disconnect_by_func (icon_view,
                                            moses_icon_view_set_tooltip_query_cb,
                                            NULL);
      ...
      if (icon_view->priv->tooltip_column == -1)
        {
          g_signal_connect (icon_view, "query-tooltip",
                            G_CALLBACK (moses_icon_view_set_tooltip_query_cb), NULL);
...
/**
 * moses_icon_view_get_tooltip_column:
 * @icon_view: a #MosesIconView
 *
 ...
 */
gint
moses_icon_view_get_tooltip_column (MosesIconView *icon_view)
{
  g_return_val_if_fail (MOSES_IS_ICON_VIEW (icon_view), 0);

  return icon_view->priv->tooltip_column;
}

/**
 * moses_icon_view_get_visible_range:
 * @icon_view: A #MosesIconView
 ...
 **/
gboolean
moses_icon_view_get_visible_range (MosesIconView  *icon_view,
...
/**
 * moses_icon_view_selected_foreach:
 * @icon_view: A #MosesIconView.
 ...
 **/
void
moses_icon_view_selected_foreach (MosesIconView           *icon_view,
				...
				gpointer               data)
{
  ...
  for (list = icon_view->priv->items; list; list = list->next)
    {
      MosesIconViewItem *item = list->data;
...
/**
 * moses_icon_view_set_selection_mode:
 * @icon_view: A #MosesIconView.
 ...
 **/
void
moses_icon_view_set_selection_mode (MosesIconView      *icon_view,
...
/**
 * moses_icon_view_get_selection_mode:
 * @icon_view: A #MosesIconView.
 * 
 ...
 **/
GtkSelectionMode
moses_icon_view_get_selection_mode (MosesIconView *icon_view)
{
  g_return_val_if_fail (MOSES_IS_ICON_VIEW (icon_view), GTK_SELECTION_SINGLE);

  return icon_view->priv->selection_mode;
}

/**
 * moses_icon_view_set_model:
 * @icon_view: A #MosesIconView.
 * @model: (allow-none): The model.
 *
 * Sets the model for a #MosesIconView.
 ...
 **/
void
moses_icon_view_set_model (MosesIconView *icon_view,
			 GtkTreeModel *model)
{
  gboolean dirty;
  ...
  if (icon_view->priv->model)
    {
      g_signal_handlers_disconnect_by_func (icon_view->priv->model,
					    moses_icon_view_row_changed,
					    icon_view);
      g_signal_handlers_disconnect_by_func (icon_view->priv->model,
					    moses_icon_view_row_inserted,
					    icon_view);
      g_signal_handlers_disconnect_by_func (icon_view->priv->model,
					    moses_icon_view_row_deleted,
					    icon_view);
      g_signal_handlers_disconnect_by_func (icon_view->priv->model,
					    moses_icon_view_rows_reordered,
					    icon_view);

      g_object_unref (icon_view->priv->model);
      
      g_list_free_full (icon_view->priv->items, (GDestroyNotify) moses_icon_view_item_free);
  ...
  if (icon_view->priv->model)
    {
      ...
      g_signal_connect (icon_view->priv->model,
			"row-changed",
			G_CALLBACK (moses_icon_view_row_changed),
			icon_view);
      g_signal_connect (icon_view->priv->model,
			"row-inserted",
			G_CALLBACK (moses_icon_view_row_inserted),
			icon_view);
      g_signal_connect (icon_view->priv->model,
			"row-deleted",
			G_CALLBACK (moses_icon_view_row_deleted),
			icon_view);
      g_signal_connect (icon_view->priv->model,
			"rows-reordered",
			G_CALLBACK (moses_icon_view_rows_reordered),
			icon_view);

      moses_icon_view_build_items (icon_view);
    }
...
/**
 * moses_icon_view_get_model:
 * @icon_view: a #MosesIconView
 *
 * Returns the model the #MosesIconView is based on.  Returns %NULL if the
 * model is unset.
 *
 ...
 **/
GtkTreeModel *
moses_icon_view_get_model (MosesIconView *icon_view)
{
  g_return_val_if_fail (MOSES_IS_ICON_VIEW (icon_view), NULL);
...
static void
update_text_cell (MosesIconView *icon_view)
{
  if (!icon_view->priv->cell_area)
    return;
...
static void
update_pixbuf_cell (MosesIconView *icon_view)
{
  if (!icon_view->priv->cell_area)
    return;
...
/**
 * moses_icon_view_set_text_column:
 * @icon_view: A #MosesIconView.
 ...
 **/
void
moses_icon_view_set_text_column (MosesIconView *icon_view,
			       gint          column)
{
...
/**
 * moses_icon_view_get_text_column:
 * @icon_view: A #MosesIconView.
 *
 ...
 */
gint
moses_icon_view_get_text_column (MosesIconView  *icon_view)
{
  g_return_val_if_fail (MOSES_IS_ICON_VIEW (icon_view), -1);

  return icon_view->priv->text_column;
}

/**
 * moses_icon_view_set_markup_column:
 * @icon_view: A #MosesIconView.
 * @column: A column in the currently used model, or -1 to display no text
 * 
 ...
 * the text column set by moses_icon_view_set_text_column().
 *
 * Since: 2.6
 **/
void
moses_icon_view_set_markup_column (MosesIconView *icon_view,
				 gint         column)
{
...
/**
 * moses_icon_view_get_markup_column:
 * @icon_view: A #MosesIconView.
 *
 ...
 */
gint
moses_icon_view_get_markup_column (MosesIconView  *icon_view)
{
  g_return_val_if_fail (MOSES_IS_ICON_VIEW (icon_view), -1);
...
/**
 * moses_icon_view_set_pixbuf_column:
 * @icon_view: A #MosesIconView.
 ...
 **/
void
moses_icon_view_set_pixbuf_column (MosesIconView *icon_view,
				 gint         column)
{
...
/**
 * moses_icon_view_get_pixbuf_column:
 * @icon_view: A #MosesIconView.
 *
 ...
 */
gint
moses_icon_view_get_pixbuf_column (MosesIconView  *icon_view)
{
  g_return_val_if_fail (MOSES_IS_ICON_VIEW (icon_view), -1);
 ...
 **/
void
moses_icon_view_select_path (MosesIconView *icon_view,
			   GtkTreePath *path)
{
  MosesIconViewItem *item = NULL;
  ...
  if (item)
    _moses_icon_view_select_item (icon_view, item);
}

/**
 * moses_icon_view_unselect_path:
 * @icon_view: A #MosesIconView.
 ...
 **/
void
moses_icon_view_unselect_path (MosesIconView *icon_view,
			     GtkTreePath *path)
{
  MosesIconViewItem *item;
  ...
  _moses_icon_view_unselect_item (icon_view, item);
}

/**
 * moses_icon_view_get_selected_items:
 * @icon_view: A #MosesIconView.
 *
 ...
 **/
GList *
moses_icon_view_get_selected_items (MosesIconView *icon_view)
{
  GList *list;
  GList *selected = NULL;
 ...
 **/
void
moses_icon_view_select_all (MosesIconView *icon_view)
{
  GList *items;
  gboolean dirty = FALSE;
 ...
 **/
void
moses_icon_view_unselect_all (MosesIconView *icon_view)
{
  gboolean dirty = FALSE;
...
/**
 * moses_icon_view_path_is_selected:
 * @icon_view: A #MosesIconView.
 ...
 **/
gboolean
moses_icon_view_path_is_selected (MosesIconView *icon_view,
				GtkTreePath *path)
{
  MosesIconViewItem *item;
 ...
 */
gint
moses_icon_view_get_item_row (MosesIconView *icon_view,
                            GtkTreePath *path)
{
  MosesIconViewItem *item;
...
/**
 * moses_icon_view_get_item_column:
 * @icon_view: a #MosesIconView
 * @path: the #GtkTreePath of the item
 *
 ...
 */
gint
moses_icon_view_get_item_column (MosesIconView *icon_view,
                               GtkTreePath *path)
{
  MosesIconViewItem *item;
...
/**
 * moses_icon_view_item_activated:
 * @icon_view: A #MosesIconView
 ...
 **/
void
moses_icon_view_item_activated (MosesIconView      *icon_view,
			      GtkTreePath      *path)
{
  g_return_if_fail (MOSES_IS_ICON_VIEW (icon_view));
  g_return_if_fail (path != NULL);
...
/**
 * moses_icon_view_set_item_orientation:
 * @icon_view: a #MosesIconView
 ...
 **/
void 
moses_icon_view_set_item_orientation (MosesIconView    *icon_view,
                                    GtkOrientation  orientation)
{
  g_return_if_fail (MOSES_IS_ICON_VIEW (icon_view));
...
/**
 * moses_icon_view_get_item_orientation:
 * @icon_view: a #MosesIconView
 * 
 ...
 **/
GtkOrientation
moses_icon_view_get_item_orientation (MosesIconView *icon_view)
{
  g_return_val_if_fail (MOSES_IS_ICON_VIEW (icon_view), 
			GTK_ORIENTATION_VERTICAL);
 ...
 */
void 
moses_icon_view_set_columns (MosesIconView *icon_view,
			   gint         columns)
{
  g_return_if_fail (MOSES_IS_ICON_VIEW (icon_view));
 ...
 */
gint
moses_icon_view_get_columns (MosesIconView *icon_view)
{
  g_return_val_if_fail (MOSES_IS_ICON_VIEW (icon_view), -1);
...
/**
 * moses_icon_view_set_item_width:
 * @icon_view: a #MosesIconView
 ...
 */
void 
moses_icon_view_set_item_width (MosesIconView *icon_view,
			      gint         item_width)
{
  g_return_if_fail (MOSES_IS_ICON_VIEW (icon_view));
...
/**
 * moses_icon_view_get_item_width:
 * @icon_view: a #MosesIconView
 * 
 ...
 */
gint
moses_icon_view_get_item_width (MosesIconView *icon_view)
{
  g_return_val_if_fail (MOSES_IS_ICON_VIEW (icon_view), -1);
 ...
 */
void 
moses_icon_view_set_spacing (MosesIconView *icon_view,
			   gint         spacing)
{
  g_return_if_fail (MOSES_IS_ICON_VIEW (icon_view));
 ...
 */
gint
moses_icon_view_get_spacing (MosesIconView *icon_view)
{
  g_return_val_if_fail (MOSES_IS_ICON_VIEW (icon_view), -1);
...
/**
 * moses_icon_view_set_row_spacing:
 * @icon_view: a #MosesIconView
 ...
 */
void 
moses_icon_view_set_row_spacing (MosesIconView *icon_view,
			       gint         row_spacing)
{
  g_return_if_fail (MOSES_IS_ICON_VIEW (icon_view));
...
/**
 * moses_icon_view_get_row_spacing:
 * @icon_view: a #MosesIconView
 * 
 ...
 */
gint
moses_icon_view_get_row_spacing (MosesIconView *icon_view)
{
  g_return_val_if_fail (MOSES_IS_ICON_VIEW (icon_view), -1);
...
/**
 * moses_icon_view_set_column_spacing:
 * @icon_view: a #MosesIconView
 ...
 */
void 
moses_icon_view_set_column_spacing (MosesIconView *icon_view,
				  gint         column_spacing)
{
  g_return_if_fail (MOSES_IS_ICON_VIEW (icon_view));
...
/**
 * moses_icon_view_get_column_spacing:
 * @icon_view: a #MosesIconView
 * 
 ...
 */
gint
moses_icon_view_get_column_spacing (MosesIconView *icon_view)
{
  g_return_val_if_fail (MOSES_IS_ICON_VIEW (icon_view), -1);
 ...
 */
void 
moses_icon_view_set_margin (MosesIconView *icon_view,
			  gint         margin)
{
  g_return_if_fail (MOSES_IS_ICON_VIEW (icon_view));
 ...
 */
gint
moses_icon_view_get_margin (MosesIconView *icon_view)
{
  g_return_val_if_fail (MOSES_IS_ICON_VIEW (icon_view), -1);
...
/**
 * moses_icon_view_set_item_padding:
 * @icon_view: a #MosesIconView
 * @item_padding: the item padding
 *
 * Sets the #MosesIconView:item-padding property which specifies the padding
 * around each of the icon view’s items.
 *
 * Since: 2.18
 */
void
moses_icon_view_set_item_padding (MosesIconView *icon_view,
				gint         item_padding)
{
  g_return_if_fail (MOSES_IS_ICON_VIEW (icon_view));
...
/**
 * moses_icon_view_get_item_padding:
 * @icon_view: a #MosesIconView
 * 
 ...
 */
gint
moses_icon_view_get_item_padding (MosesIconView *icon_view)
{
  g_return_val_if_fail (MOSES_IS_ICON_VIEW (icon_view), -1);
...
static void
unset_reorderable (MosesIconView *icon_view)
{
  ...
  if (model == NULL || !G_TYPE_CHECK_INSTANCE_TYPE ((model), required_iface))
    {
      g_warning ("You must override the default '%s' handler "
                 "on MosesIconView when using models that don't support "
...
static void
remove_scroll_timeout (MosesIconView *icon_view)
{
  if (icon_view->priv->scroll_timeout_id != 0)
    {
...
static void
moses_icon_view_autoscroll (MosesIconView *icon_view,
                          GdkDevice   *device)
{
  GdkWindow *window;
...
drag_scroll_timeout (gpointer datap)
{
  ...
  moses_icon_view_autoscroll (data->icon_view, data->device);
...
static gboolean
set_destination (MosesIconView    *icon_view,
		 GdkDragContext *context,
		 gint            x,
		 gint            y,
		 GdkDragAction  *suggested_action,
		 GdkAtom        *target)
{
  ...
  MosesIconViewDropPosition old_pos;
  ...
  if (!icon_view->priv->dest_set)
    {
      ...
      moses_icon_view_set_drag_dest_item (icon_view,
					NULL,
					MOSES_ICON_VIEW_DROP_LEFT);

      remove_scroll_timeout (MOSES_ICON_VIEW (widget));
  ...
  *target = gtk_drag_dest_find_target (widget, context,
  ...
  if (!moses_icon_view_get_dest_item_at_pos (icon_view, x, y, &path, &pos)) 
    {
      gint n_children;
      GtkTreeModel *model;
	...
	gtk_tree_path_free (path);
      ...
      if (n_children)
        {
          pos = MOSES_ICON_VIEW_DROP_BELOW;
          path = gtk_tree_path_new_from_indices (n_children - 1, -1);
        }
      else
        {
          pos = MOSES_ICON_VIEW_DROP_ABOVE;
          path = gtk_tree_path_new_from_indices (0, -1);
        }
  ...
  moses_icon_view_get_drag_dest_item (icon_view,
				    &old_dest_path,
				    &old_pos);
  ...
  if (can_drop)
    {
      ...
      *suggested_action = gdk_drag_context_get_suggested_action (context);
      ...
      moses_icon_view_set_drag_dest_item (MOSES_ICON_VIEW (widget),
					path, pos);
    }
  else
    {
...
static GtkTreePath*
get_logical_destination (MosesIconView *icon_view,
			 gboolean    *drop_append_mode)
{
  ...
  *drop_append_mode = FALSE;
  ...
  moses_icon_view_get_drag_dest_item (icon_view, &path, &pos);

  if (path == NULL)
    return NULL;

  if (pos == MOSES_ICON_VIEW_DROP_RIGHT || 
      pos == MOSES_ICON_VIEW_DROP_BELOW)
    {
      GtkTreeIter iter;
...
static gboolean
moses_icon_view_maybe_begin_drag (MosesIconView    *icon_view,
				GdkEventMotion *event)
{
  GtkWidget *widget = GTK_WIDGET (icon_view);
  GdkDragContext *context;
  ...
  path = moses_icon_view_get_path_at_pos (icon_view,
					icon_view->priv->press_start_x,
					icon_view->priv->press_start_y);
...
static void 
moses_icon_view_drag_end (GtkWidget      *widget,
			GdkDragContext *context)
{
  /* do nothing */
}
...
static void 
moses_icon_view_drag_data_get (GtkWidget        *widget,
			     GdkDragContext   *context,
			     GtkSelectionData *selection_data,
			     guint             info,
			     guint             time)
...
static void 
moses_icon_view_drag_data_delete (GtkWidget      *widget,
				GdkDragContext *context)
{
  GtkTreeModel *model;
  MosesIconView *icon_view;
...
/* Target side drag signals */
static void
moses_icon_view_drag_leave (GtkWidget      *widget,
			  GdkDragContext *context,
			  guint           time)
{
  MosesIconView *icon_view;
...
static gboolean 
moses_icon_view_drag_drop (GtkWidget      *widget,
			 GdkDragContext *context,
			 gint            x,
			 gint            y,
			 guint           time)
{
  ...
  /* Unset this thing */
  moses_icon_view_set_drag_dest_item (icon_view, NULL, MOSES_ICON_VIEW_DROP_LEFT);
...
static void
moses_icon_view_drag_data_received (GtkWidget        *widget,
				  GdkDragContext   *context,
				  gint              x,
				  gint              y,
				  GtkSelectionData *selection_data,
...
/**
 * moses_icon_view_enable_model_drag_source:
 * @icon_view: a #MosesIconView
 ...
 * method sets #MosesIconView:reorderable to %FALSE.
 *
 * Since: 2.8
 **/
void
moses_icon_view_enable_model_drag_source (MosesIconView              *icon_view,
					GdkModifierType           start_button_mask,
...
/**
 * moses_icon_view_enable_model_drag_dest:
 * @icon_view: a #MosesIconView
 * @targets: (array length=n_targets): the table of targets that the drag will
 *           support
 * @n_targets: the number of items in @targets
 ...
 **/
void 
moses_icon_view_enable_model_drag_dest (MosesIconView          *icon_view,
				      const GtkTargetEntry *targets,
				      gint                  n_targets,
				      GdkDragAction         actions)
{
...
/**
 * moses_icon_view_unset_model_drag_source:
 * @icon_view: a #MosesIconView
 * 
 * Undoes the effect of moses_icon_view_enable_model_drag_source(). Calling this
 * method sets #MosesIconView:reorderable to %FALSE.
 *
 * Since: 2.8
 **/
void
moses_icon_view_unset_model_drag_source (MosesIconView *icon_view)
{
  g_return_if_fail (MOSES_IS_ICON_VIEW (icon_view));
...
/**
 * moses_icon_view_unset_model_drag_dest:
 * @icon_view: a #MosesIconView
 * 
 * Undoes the effect of moses_icon_view_enable_model_drag_dest(). Calling this
 * method sets #MosesIconView:reorderable to %FALSE.
 *
 * Since: 2.8
 **/
void
moses_icon_view_unset_model_drag_dest (MosesIconView *icon_view)
{
  g_return_if_fail (MOSES_IS_ICON_VIEW (icon_view));
...
/**
 * moses_icon_view_set_drag_dest_item:
 * @icon_view: a #MosesIconView
 ...
 */
void
moses_icon_view_set_drag_dest_item (MosesIconView              *icon_view,
				  GtkTreePath              *path,
				  MosesIconViewDropPosition   pos)
{
  ...
  if (icon_view->priv->dest_item)
    {
      ...
      moses_icon_view_queue_draw_path (icon_view, current_path);
      gtk_tree_path_free (current_path);
    }
  
  /* special case a drop on an empty model */
  icon_view->priv->empty_view_drop = FALSE;
  if (pos == MOSES_ICON_VIEW_DROP_ABOVE && path
...
/**
 * moses_icon_view_get_drag_dest_item:
 * @icon_view: a #MosesIconView
 ...
 **/
void
moses_icon_view_get_drag_dest_item (MosesIconView              *icon_view,
				  GtkTreePath             **path,
				  MosesIconViewDropPosition  *pos)
{
  g_return_if_fail (MOSES_IS_ICON_VIEW (icon_view));
...
/**
 * moses_icon_view_get_dest_item_at_pos:
 * @icon_view: a #MosesIconView
 ...
 **/
gboolean
moses_icon_view_get_dest_item_at_pos (MosesIconView              *icon_view,
				    gint                      drag_x,
				    gint                      drag_y,
				    GtkTreePath             **path,
				    MosesIconViewDropPosition  *pos)
...
/**
 * moses_icon_view_create_drag_icon:
 * @icon_view: a #MosesIconView
 ...
 **/
cairo_surface_t *
moses_icon_view_create_drag_icon (MosesIconView *icon_view,
				GtkTreePath *path)
{
  GtkWidget *widget;
  cairo_t *cr;
...
/**
 * moses_icon_view_get_reorderable:
 * @icon_view: a #MosesIconView
 *
 * Retrieves whether the user can reorder the list via drag-and-drop. 
 * See moses_icon_view_set_reorderable().
 *
 ...
 **/
gboolean
moses_icon_view_get_reorderable (MosesIconView *icon_view)
{
  g_return_val_if_fail (MOSES_IS_ICON_VIEW (icon_view), FALSE);
...
/**
 * moses_icon_view_set_reorderable:
 * @icon_view: A #MosesIconView.
 ...
 **/
void
moses_icon_view_set_reorderable (MosesIconView *icon_view,
			       gboolean     reorderable)
{
  ...
  if (reorderable)
    {
      moses_icon_view_enable_model_drag_source (icon_view,
					      GDK_BUTTON1_MASK,
					      item_targets,
					      G_N_ELEMENTS (item_targets),
					      GDK_ACTION_MOVE);
      moses_icon_view_enable_model_drag_dest (icon_view,
					    item_targets,
					    G_N_ELEMENTS (item_targets),
					    GDK_ACTION_MOVE);
    }
    ...
    {
      moses_icon_view_unset_model_drag_source (icon_view);
      moses_icon_view_unset_model_drag_dest (icon_view);
    }
...
/**
 * moses_icon_view_set_activate_on_single_click:
 * @icon_view: a #MosesIconView
 * @single: %TRUE to emit item-activated on a single click
 *
 * Causes the #MosesIconView::item-activated signal to be emitted on
 * a single click instead of a double click.
 *
 * Since: 3.8
 **/
void
moses_icon_view_set_activate_on_single_click (MosesIconView *icon_view,
                                            gboolean     single)
{
  g_return_if_fail (MOSES_IS_ICON_VIEW (icon_view));
...
/**
 * moses_icon_view_get_activate_on_single_click:
 * @icon_view: a #MosesIconView
 *
 * Gets the setting set by moses_icon_view_set_activate_on_single_click().
 *
 ...
 **/
gboolean
moses_icon_view_get_activate_on_single_click (MosesIconView *icon_view)
{
  g_return_val_if_fail (MOSES_IS_ICON_VIEW (icon_view), FALSE);
...
static gboolean
moses_icon_view_buildable_custom_tag_start (GtkBuildable  *buildable,
                                          GtkBuilder    *builder,
                                          GObject       *child,
                                          const gchar   *tagname,
                                          GMarkupParser *parser,
...
static void
moses_icon_view_buildable_custom_tag_end (GtkBuildable *buildable,
                                        GtkBuilder   *builder,
                                        GObject      *child,
                                        const gchar  *tagname,
                                        gpointer     *data)
